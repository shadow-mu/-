...
3.  <img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220721145212200.png" alt="image-20220721145212200" style="zoom:50%;" />            <img src="img/image-20220721152653266.png" alt="image-20220721152653266" style="zoom:67%;" />
4.  对数恒等式  e^lnA^ =A   
5.  log^b^$_{a}$ =<img src="img/image-20220721152348441.png" alt="image-20220721152348441" style="zoom: 50%;" />                <img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220721152912011.png" alt="image-20220721152912011" style="zoom:50%;" />          
...
1. 求初等函数及分段函数的定义域
   ...
   7. 例子
      ...
      y=$\frac{{√￣64-x^2 }}{ln(x-5)}$ **<img src="img/image-20220723100350978.png" alt="image-20220723100350978" style="zoom:50%;" />** <img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723100827715.png" alt="image-20220723100827715" style="zoom:50%;" />![image-20220723100836994](img/image-20220723100836994.png)
   ...
   8. 真题   
      ...
      1. 2017 .11 <img src="img/image-20220723104051938.png" alt="image-20220723104051938" style="zoom:80%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723114002941.png" alt="image-20220723114002941" style="zoom:50%;" />
      2. 2018.11  <img src="img/image-20220723104058841.png" alt="image-20220723104058841" style="zoom:67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723114031759.png" alt="image-20220723114031759" style="zoom: 67%;" />
      3. 2019.11  <img src="img/image-20220723104108224.png" alt="image-20220723104108224" style="zoom:67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723114058911.png" alt="image-20220723114058911" style="zoom: 50%;" />
      4. 2020.11  <img src="img/image-20220723104118233.png" alt="image-20220723104118233" style="zoom: 67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723114140558.png" alt="image-20220723114140558" style="zoom:67%;" />
      5. 2021.11 <img src="img/image-20220723104128425.png" alt="image-20220723104128425" style="zoom:67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723114219581.png" alt="image-20220723114219581" style="zoom:67%;" />
      6. 2022.11 <img src="img/image-20220723104139361.png" alt="image-20220723104139361" style="zoom:67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220723114241494.png" alt="image-20220723114241494" style="zoom: 50%;" />
      7. 第6题   分段函数取并集   
...
- 例题
  ...
  3. :<img src="img/image-20221108165335405.png" alt="image-20221108165335405" style="zoom: 50%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20221108170042185.png" alt="image-20221108170042185" style="zoom:50%;" />
...
- 例题：
  ...
  9. :<img src="img/image-20221108203207310.png" alt="image-20221108203207310" style="zoom:50%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20221108204445169.png" alt="image-20221108204445169" style="zoom: 25%;" />
...
- 例：
  ...
  4. $\lim_{x\rightarrow \infty} \frac{{3x^4-2x^2-7}}{5x^2+3}$=$\infty$  <img src="img/image-20220728152203459.png" alt="image-20220728152203459" style="zoom:67%;" />   5分之无穷大=无穷大
     ...
     <img src="img/image-20220728152508338.png" alt="image-20220728152508338" style="zoom:67%;" />      <img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220728152625860.png" alt="image-20220728152625860" style="zoom:50%;" />

     **口诀分母大则为0 分子大则为$\infty$ 相等看系数**

  5. 2020.12  $\lim_{x\rightarrow \infty} \frac{{2x^2+10x-1}}{3x^3-5x^2+8}$=0

  6. 2022.12 $\lim_{x\rightarrow \infty} \frac{{ax^2}}{(x+2)^3-x^3}$=2   则a=<img src="img/image-20220729102050954.png" alt="image-20220729102050954" style="zoom:50%;" /> <img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220729101642448.png" alt="image-20220729101642448" style="zoom: 33%;" />
...
- **必背八个等价无穷小代换**
  ...
  - ![image-20220730192447419](img/image-20220730192447419.png)<img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220730192520485.png" alt="image-20220730192520485" style="zoom: 67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220730192922032.png" alt="image-20220730192922032" style="zoom: 80%;" />
  ...
  - 例题：
    ...
    2. $\lim_{x\rightarrow 0} \frac{{sinx}}{x^2}$=   sin(x)是x^2^的___无穷小  低阶
       ...
       <img src="img/image-20220730195202983.png" alt="image-20220730195202983" style="zoom:67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20221109204847317.png" alt="image-20221109204847317" style="zoom: 50%;" />
  ...
  - 例题：
    ...
    例4 <img src="img/image-20220730201209873.png" alt="image-20220730201209873" style="zoom: 50%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220730201659891.png" alt="image-20220730201659891" style="zoom:50%;" />
  ...
  - ![image-20230210133621686](img/image-20230210133621686.png)
...
2. 例题
   ...
   -  :<img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220804100256928.png" alt="image-20220804100256928" style="zoom:50%;" /><img src="img/image-20220804100530787.png" alt="image-20220804100530787" style="zoom:67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20220804100542316.png" alt="image-20220804100542316" style="zoom:67%;" />

3. 例题

   - :<img src="img/image-20220804101045841.png" alt="image-20220804101045841" style="zoom: 67%;" /><img src="../../../../../笔记源文件/专升本/第一轮课/数学/精华版笔记/导学课/img/image-20221110145914896.png" alt="image-20221110145914896" style="zoom: 56%;" />
