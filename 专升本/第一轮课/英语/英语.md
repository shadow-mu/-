...
- 一般将来时的标志词：next week下周，next day,next month 下个月，**next** term下学期，the day after **tomorrow**,**tomorrow** morning,**tomorrow** **evening(晚上)**,**tomorrow** afternoon，soon不久之后，some day(未来的某一天)，one day 未来的某一天，in the future在未来，**in+时间段（在…之后 in three years三年后）**
...
1. quantities of 名词-大量的（复数）
2. quantity 数量 quality 质量
3. A of B B的A the door of the room
...
4. 判断正误题（每个选项都要看）
5. 原则：**转折后中心**原则
   - 转折词：but,however然而.while然而，in fact事实上 though/although尽管（另一部分为中心）
6. 当四个选项有共同词汇，可以用共同词汇作为关键词
...
1. 通读全文，尽量抓取大意-确定主旨
2. 逐句翻译：能翻译的直接翻译 不能翻译：找主干（主谓宾）
3. 翻译修饰语，插入正确位置（靠汉语解决）
4. 不认识：根据主旨确定词义-不影响句意跳过去
5. 读一遍，捋顺语言

## 作文

1. 写作20分(20--25min)(90--100词)

2. 文体：信件（建议信，感谢信，邀请信，道歉信，投诉信，推荐信，祝贺信，询价信，求职信），通知，备忘录，电子邮件，招聘广告，简历，招领启事，演讲稿，日记，欢迎词

3. 格式：三段式（重点：首尾段中间段：翻译--题目里所给的汉语提示必须“全部”
   翻译，不能有任何信息点遗落-用最简单的句式和单词)

4. 高级词汇替换：背3一5高级词汇

   ```
   good--wonderful,very---completely,happy---delighted,some/many---several/a couple of,be important=be of great importance,important----significant,like=be fond of,should do---be supposed to do--be expected to do,I think--as far as I am concerned,----in my view---in my opinion
   ```

5. 正确语法：动词时态（一般现在时-单三一般将来时）名词单复数

6. 高级句型：强调句，被动语态，定从，if虚拟，宾从

   ```
   As it is known to all,句子.（众所周知）
   There is no doubt that+句子.(…是毫无疑问的)
   ```
...
8. 标点：逗号 句号
   ...
   ```
   This is a book,this is a pen. 错
   This is a book.This is a pen.This is a book,and this is a pen.
   ```

9. 格式（书信类）

   ![image-20230113184855442](img/image-20230113184855442.png)
...
10. 书信类模板
    ...
    ![image-20230113191712335](img/image-20230113191712335.png)
...
12. 招聘广告
    ...
    ```
    			Marketing Assistants(招聘啥写啥) Wanted(必须写)
...
16. 招领启示
    ...
    ```
    											日期：Sep.6,2012(写在右上角)
    	I happened to find a Chinese dictionary in our school this afternoon,inside which there are some cards and other things.Loser is expected to call me by 223--4567to claim it.
    													Sonia(写在右下方)
    (今天下午在学校捡到一bi本汉语词典，内有几张卡片。请失者给我拨打电话
    223-4567认领为盼。)
    ```
